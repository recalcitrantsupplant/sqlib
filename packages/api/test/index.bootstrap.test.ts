...
describe('index bootstrap', () => {
  ...
  afterEach(() => {
    ...
    vi.unmock('@fastify/multipart');
    vi.unmock('@fastify/swagger');
    vi.unmock('@fastify/swagger-ui');
    vi.unmock('../src/lib/validator-setup.ts');
    vi.unmock('../src/lib/MemoryCacheManager.js');
    vi.unmock('../src/lib/CacheMonitoringService.js');
    vi.unmock('../src/lib/OxigraphStoreManager.js');
    vi.unmock('../src/routes/backends.js');
    vi.unmock('../src/routes/queries.js');
    vi.unmock('../src/routes/detection.js');
    vi.unmock('../src/routes/query-groups.js');
    vi.unmock('../src/routes/libraries.js');
    vi.unmock('../src/routes/execute.js');
    vi.unmock('../src/routes/sparql.js');
    vi.unmock('@sparql-query-lib/contracts/schema');
    vi.unmock('../src/otel-setup.js');
  });
...
afterAll(() => {
  ...
  vi.unmock('@fastify/swagger');
  vi.unmock('@fastify/swagger-ui');
  vi.unmock('../../src/lib/validator-setup.js');
  vi.unmock('../../src/lib/MemoryCacheManager.js');
  vi.unmock('../../src/lib/CacheMonitoringService.js');
  vi.unmock('../../src/lib/OxigraphStoreManager.js');
  vi.unmock('../../src/routes/backends.js');
