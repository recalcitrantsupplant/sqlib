 ...
 *
 * The divider sits above Backends, not below Connect. Connections are
...
export const RAIL_ENTRIES: RailEntry[] = [
  ...
  { section: 'connect', label: 'Connect', title: 'Connect — use this library from Claude or ChatGPT', icon: Plug, feature: 'connect' },
  {
    section: 'backends',
    label: 'Backends',
