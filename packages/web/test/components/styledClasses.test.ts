...
const HOOKS: Record<string, string> = {
  ...
  'library-menu': 'LibrarySwitcher: the menu is teleported, so its width is set in utilities',
  ...
  'section-title': 'RuleSetExecutionResults: SectionLabel carries the type',
